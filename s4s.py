...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author     SANAM SAGAR 'S4S HACKING ZONE'
    Name       SAGAR.S'Open Source Information Facebook'
    CodeName   S4S
    version    full version
    Date       07/10/2020 09:35:12
    Team       The Shield
    Email      sagar123@gmail.com
    Telegram   @S4S Hacking Zone
